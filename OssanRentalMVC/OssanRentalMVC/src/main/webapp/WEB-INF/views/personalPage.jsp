		...
		<div class="row mt-5">
			...
			<div class="col-sm-6 col-12">
				...
				<div class="price w-75 mx-auto mt-4 ">
					...
					<select class="form-control" name="hours" id="exampleFormControlSelect1">
						<option>1</option>
						<option>2</option>
						<option>3</option>
						<option>4</option>
						...
						href='<c:url value="/addToCart/${OssanBean.ossanNo}" />'
						class="btn btn-secondary btn-lg btn-block mt-5">加入購物車</a>
				</div>
