			...
			<div class="container-fluid ">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav mr-auto ">
						...
						<li class="nav-item px-2"><a class="nav-link text-dark"
							href="<c:url value="/orderList/${LoginOK.ossanNo}" />">個人訂單紀錄</a></li>
		...
		<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top"
			...
			<div class="container-fluid ">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav mr-auto ">
						<li class="nav-item px-2"><a class="nav-link text-dark"
							href="<c:url value="/manageArticle" />">全部故事管理</a></li>
						<li class="nav-item px-2"><a class="nav-link text-dark"
							href="<c:url value="/manageOssan" />">全部大叔管理</a></li>
						<li class="nav-item px-2"><a class="nav-link text-dark"
							href="<c:url value="/articleList" />">大叔故事</a></li>
						<li class="nav-item px-2"><a class="nav-link text-dark"
							href="<c:url value="/manageOrder" />">全部訂單紀錄</a></li>
					</ul>
					<ul class="navbar-nav ml-auto ">
						<li class="nav-item px-2"><a class="nav-link text-dark"
